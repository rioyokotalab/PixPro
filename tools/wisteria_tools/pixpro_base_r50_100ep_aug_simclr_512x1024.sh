...
# output_dir="./output/pixpro_base_r50_100ep/imagenet/$bs/$aug/512x1024/$date_str"
output_dir="./output/pixpro_base_r50_100ep/imagenet/16/SimCLR/512x1024/20220531_102329"
